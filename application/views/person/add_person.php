    ...
    <div class="card-body">
      ...
      <form action="" method="post" enctype="multipart/form-data">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="name" name="name" placeholder="Enter person name" value="<?php echo set_value('name'); ?>">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control salary" id="salary" name="salary" placeholder="Enter salary" value="<?php echo set_value('salary'); ?>">
          <small class="form-text text-danger"><?= form_error('salary'); ?></small>
        </div>
        <div class="form-group">
          <label for="address">Address</label>
          <textarea class="form-control" placeholder="Address.." name="address" id="address"><?php echo set_value('address'); ?></textarea>
